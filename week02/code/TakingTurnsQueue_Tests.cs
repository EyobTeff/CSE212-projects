...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: People are returned in LIFO order (stack behavior) instead of FIFO queue order.
    ...
    // Defect(s) Found: No defect found for empty-queue exception handling.
